...
const createMedicalRecord = async (req, res, next) => {
    try {
      ...
      return successResponse(res, "Medical record created successfully", medicalRecord);
    } catch (error) {
      next(error); 
    }
  };
  ...
  const getMedicalRecordById = async (req, res, next) => {
    try {
      ...
      return successResponse(res, "Medical record retrieved successfully", record);
    } catch (error) {
      next(error); 
    }
  };
  ...
  const updateMedicalRecord = async (req, res, next) => {
    try {
      ...
      return successResponse(res, "Medical record updated successfully", updatedRecord);
    } catch (error) {
      next(error);
    }
  };
